// GLSL ES 1.00
//#extension GL_OES_texture_float : require         // for floating‐point textures
//#extension GL_EXT_color_buffer_float : require    // for rendering to RGBA32F
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    vec3 rd = normalize(vec3(2.0 * fragCoord - uResolution.xy, uResolution.y));
    vec2 m = sin(vec2(0.0, 1.57079632) + uTime / 4.0);
...
void main() {
    vec2 fragCoord = vFragCoord * uResolution;
    vec4 outColor;
